...
async function getPrincipalMessage(): Promise<PrincipalMessage | null> {
...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const title = "প্রধান শিক্ষকের বাণী";
    const description = message?.quote || 'প্রধান শিক্ষকের বাণী পড়ুন।';
            ...
            <div className="container mx-auto px-4 py-12">
                <Card className="shadow-lg">
                    ...
                    <CardContent className="p-8">
                        <p className="text-center text-muted-foreground">প্রধান শিক্ষকের বাণী পাওয়া যায়নি। অনুগ্রহ করে Sanity Studio-তে তথ্য যোগ করুন।</p>
                    </CardContent>
                </Card>
            </div>
        </main>
